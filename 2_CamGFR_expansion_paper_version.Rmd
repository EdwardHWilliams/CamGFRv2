...
cambridge_stat_3methods_tbl <- tableGrob(cambridge_stat_3methods[,c(2:4)],
                                         rows=NULL)
...
p_idms <- ggplot(data=idms,
  ...
  stat_compare_means(aes(x = 10^Creat),
                     ...
                     tip.length = 0.01,
                     inherit.aes = F,
                     label.y = c(log10(2.5),log10(3.5), log10(5)),
                     size=label_size
  ) +
...
p_nonidms <- ggplot(data=nonidms,
  ...
  geom_violin(position = "dodge", width = 0.9, show.legend = showlegends,
              draw_quantiles=0.5, color=method_colors[2], alpha=0.8
              ) + 
