...
p1 <- df_mixed %>%
  ...
  stat_summary(data = df_mixed %>%
               ...
               size = 2.5, colour = "white") +
  # ylim(-1.5, 2.5) + 
  coord_trans(y = "log10", ylim = c(exp(-1.8), exp(2.15))) +
...
Results_list <- list(Results = Results, 
                     Results_CreatType = Results_CreatType, 
                     Results_CreatType = Results_CreatType, 
                     Results_Centre_CreatType = Results_Centre_CreatType, 
                     Results_Centre = Results_Centre, 
                     Results_Diagnosis = Results_Diagnosis, 
                     Results_PatientType_Creattype = Results_PatientType_Creattype, 
                     Results_Age_Creattype = Results_Age_Creattype, 
                     Results_BSA_Creattype = Results_BSA_Creattype, 
                     Results_Sex_Creattype = Results_Sex_Creattype, 
                     Results_eGFR_Creattype = Results_eGFR_Creattype, 
                     Results_BSAadj_eGFR_Creattype = Results_BSAadj_eGFR_Creattype, 
                     Results_BSAadj_eGFR_Creattype_on_BSAadj_eGFR_scale = Results_BSAadj_eGFR_Creattype_on_BSAadj_eGFR_scale)
...
df <- Results_list[[2]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "Creatinine_type","variable"))
...
df <- Results_list[[7]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "Age_cut", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "Age_cut", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "Age_cut", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "Age_cut", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "Age_cut", "Creatinine_type","variable"))
names(melt.df_upr) <- "upr"
...
df <- Results_list[[8]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "BSA_cut", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "BSA_cut", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "BSA_cut", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "BSA_cut", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "BSA_cut", "Creatinine_type","variable"))
names(melt.df_upr) <- "upr"
...
df <- Results_list[[9]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "Sex", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "Sex", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "Sex", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "Sex", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "Sex", "Creatinine_type","variable"))
names(melt.df_upr) <- "upr"
...
df <- Results_list[[6]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "Patient_type", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "Patient_type", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "Patient_type", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "Patient_type", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "Patient_type", "Creatinine_type","variable"))
names(melt.df_upr) <- "upr"
...
df <- Results_list[[10]] %>% select(-"median_fitted")
melt.df <- melt(df[,c("equation", "eGFR_cut", "Creatinine_type", "RMSE", "median", "IQR", "P20", "P20_dose")])
melt.df_lwr <- melt(df[,c("equation", "eGFR_cut", "Creatinine_type", "RMSE_lwr", "median_lwr", "IQR_lwr", "P20_lwr", "P20_dose_lwr")]) %>% select(-c("equation", "eGFR_cut", "Creatinine_type","variable"))
names(melt.df_lwr) <- "lwr"
melt.df_upr <- melt(df[,c("equation", "eGFR_cut", "Creatinine_type", "RMSE_upr", "median_upr", "IQR_upr", "P20_upr", "P20_dose_upr")]) %>% select(-c("equation", "eGFR_cut", "Creatinine_type","variable"))
names(melt.df_upr) <- "upr"
